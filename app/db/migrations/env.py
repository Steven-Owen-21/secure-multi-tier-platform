...
This module configures Alembic to work with asyncpg and reads the database
URL from the DATABASE_URL environment variable (same source as the app config).
"""
...
def run_migrations_offline() -> None:
    ...
    This is useful for generating SQL to run manually.
    """
...
def run_migrations_online() -> None:
    """Entry point for online migration mode — delegates to async runner."""
